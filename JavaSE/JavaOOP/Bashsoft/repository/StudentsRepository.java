...
public class StudentsRepository implements Database {
    ...
    @Override
    public SimpleSortedList<Student> getAllStudentSorted(Comparator<Student> cmp) {
        SimpleSortedList<Student> sortedStudentsList = new SimpleSortedList<>(Student.class, cmp);
        sortedStudentsList.addAll(this.students.values());
